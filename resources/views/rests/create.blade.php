                        ...
                        <form method="post" action="{{ route('team.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('admin_id') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="admin_id" id="input-admin_id" class="form-control form-control-alternative{{ $errors->has('admin_id') ? ' is-invalid' : '' }}" placeholder="{{ __('admin_id') }}" value="{{ old('admin_id') }}" required autofocus>
