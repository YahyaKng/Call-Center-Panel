<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="{{ route('home') }}">
            <img src="{{ asset('argon') }}/img/brand/alopeyk.jpg" class="navbar-brand-img" alt="..." style="">
        </a>
        <!-- User -->
            ...
            <div class="navbar-collapse-header d-md-none">
                <div class="row">
                    <div class="col-6 collapse-brand">
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('argon') }}/img/brand/alopeyk.jpg">
                        </a>
                    </div>
            ...
            <ul class="navbar-nav">
                ...
                <!-- <li class="nav-item"> -->
                    <!-- <a class="nav-link active" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                        ...
                        <span class="nav-link-text" style="color: #f4645f;">{{ __('Alopeyk ') }}</span>
                    </a> -->
                <li class="nav-item">
                ...
                @if(auth()->user()->role_id != 3)
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('team.edit') }}">
                            {{ __('Team Management') }}
                        </a>
                    </li>
                    <li class="nav-item">
